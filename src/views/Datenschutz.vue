  ...
  <div>
    ...
    <section id="datenschutz">
      ...
      <article>
          ...
          Musterweg 100<br />
          90210 Musterstadt</p> -->
          <h5>Abschluss eines Vertrages &uuml;ber Auftragsverarbeitung</h5> <p>Um die datenschutzkonforme Verarbeitung zu gew&auml;hrleisten, haben wir einen Vertrag &uuml;ber Auftragsverarbeitung mit unserem Hoster geschlossen.</p>
          ...
          <h4>Hinweis zur verantwortlichen Stelle</h4> <p>Die verantwortliche Stelle f&uuml;r die Datenverarbeitung auf dieser Website ist:</p>
          <p>Florian Gläser<br />
          ...
          <h4>IcoMoon</h4> <p>Diese Seite nutzt zur einheitlichen Darstellung von Icons so genannte Icon Fonts von IcoMoon.io. Diese wird mit einzelne Icons aus verschiedenen Icon Librarys zu einer Icon Font zusammen gefügt. Hierbei handelt es sich um Schriftarten, die beim Aufrufen unserer Website in Ihren Browser geladen werden, um ein einheitliches Schriftbild bei der Webseitendarstellung zu gew&auml;hrleisten.</p> <p>Die Fonts sind lokal installiert. Eine Verbindung zu Servern von IcoMoon.io findet dabei nicht statt. Der Einsatz der Fonts erfolgt auf Grundlage unseres berechtigten Interesses an einer einheitlichen Darstellung unserer Website (Art. 6 Abs. 1 lit. f DSGVO).</p>
